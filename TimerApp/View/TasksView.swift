                        ...
                        VStack {
                            ...
                            VStack(spacing: 15) {
                                ...
                                Button {
                                    ...
                                    if !Task1.isEmpty { tasksViewModel.addTask(taskName: Task1, cycle: 1) }
                                    if !Task2.isEmpty { tasksViewModel.addTask(taskName: Task2, cycle: 2) }
                                    if !Task3.isEmpty { tasksViewModel.addTask(taskName: Task3, cycle: 3) }
                                    if !Task4.isEmpty { tasksViewModel.addTask(taskName: Task4, cycle: 4) }
